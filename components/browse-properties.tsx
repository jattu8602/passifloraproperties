  ...
  return (
    <section className="bg-white py-12 md:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-8">Browse properties in Maharashtra, India</h2>
        ...
        <div className="bg-gray-100 rounded-2xl p-8 md:p-10 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600">Find a trusted expert, no obligations.</p>
            </div>
          </div>
          <button className="bg-black text-white px-8 py-3 rounded-full font-bold hover:bg-gray-800 transition whitespace-nowrap">
            Start now
          </button>
        </div>
      </div>
