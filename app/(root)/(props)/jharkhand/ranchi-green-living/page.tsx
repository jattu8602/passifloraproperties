...
const RanchiGreenLivingPage = () => {
  ...
  const faqs = [
    {
      ...
      answer:
        'The project spans 3 acres of residential freehold land with plot sizes starting from approximately 2000 sq. ft.',
    },
    {
      question: 'What is the location advantage?',
      answer:
        'The project is located near ITBP and Central University, just 10 mins from Central University of Jharkhand and 25 mins from Ranchi Airport.',
    },
    {
      question: 'What infrastructure is planned?',
      answer:
        'The project includes wide internal roads, planned utilities, drainage, and electrification for reliable living.',
    },
    {
      question: 'Is the property freehold?',
      answer:
        'Yes, all plots come with freehold titles, ensuring complete ownership and legal clarity.',
    },
    {
      question: 'What is the investment potential?',
      answer:
        'The project offers high ROI potential in a rapidly developing corridor with strong end-user demand from education and health sector staff.',
    },
    {
      question: 'What makes this location special?',
      answer:
        'The project offers a calm, low-density environment with green buffers, peaceful surroundings, and excellent connectivity to essential facilities.',
    },
  ]
  ...
  const mapEmbedUrl = `https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3771.5!2d${projectData.longitude}!3d${projectData.latitude}!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMjPCsDI1JzEyLjAiTiA4NcKwMTgnMTguMCJF!5e1!3m2!1sen!2sin!4v${Date.now()}!5m2!1sen!2sin`
            ...
            {[
              {
                ...
                desc: 'Near Central University and ITBP',
                icon: MapPin,
              },
              {
                title: 'Freehold Property',
                desc: 'Complete ownership with legal clarity',
                icon: Check,
              },
              {
                title: 'Planned Infrastructure',
                desc: 'Wide roads, utilities, and drainage',
                icon: Check,
              },
              {
                title: 'High ROI Potential',
                desc: 'Rapidly developing corridor',
                icon: Check,
              },
              {
                title: 'Peaceful Environment',
                desc: 'Low-density with green buffers',
                icon: Check,
              },
              {
                title: 'Strong Demand',
                desc: 'End-user demand from professionals',
                icon: Check,
              },
            ].map((feature, index) => (
              <Card
...
export default RanchiGreenLivingPage
