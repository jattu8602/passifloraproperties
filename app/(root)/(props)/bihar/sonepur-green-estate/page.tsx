...
const SonepurGreenEstatePage = () => {
  ...
  const faqs = [
    {
      ...
      answer:
        'The Sonepur Green Estate spans approximately 18 Kattha (~24,300 sq. ft) of residential land.',
    },
    {
      question: 'What are the plot sizes available?',
      answer:
        'Plot sizes start from approximately 1500 sq. ft, ideal for independent homes or a small gated community.',
    },
    {
      question: 'What is the location advantage?',
      answer:
        'The project is located just 2 minutes from Patna–Chapra National Highway, with excellent connectivity to Patna (20 mins) and Hajipur (15 mins).',
    },
    {
      question: 'What infrastructure is available?',
      answer:
        'The project has peaceful surroundings with electricity and water access, and clean soil profile ready for immediate plotting and build-out.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'The neighbourhood is poised for mixed residential–commercial growth with attractive entry pricing and strong end-user demand.',
    },
  ]
  ...
  const mapEmbedUrl = `https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3771.5!2d${projectData.longitude}!3d${projectData.latitude}!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMjXCsDQyJzE4LjAiTiA4NcKwMTAnMTIuMCJF!5e1!3m2!1sen!2sin!4v${Date.now()}!5m2!1sen!2sin`
            ...
            {[
              {
                ...
                desc: 'Just 2 minutes from National Highway',
                icon: MapPin,
              },
              {
              ...
              },
              {
                ...
                desc: 'Electricity and water access available',
                icon: Check,
              },
              {
                title: 'Excellent Connectivity',
                desc: 'Easy access to Patna and Hajipur',
                icon: MapPin,
              },
              {
                title: 'Growth Potential',
                desc: 'Mixed residential–commercial growth',
                icon: Check,
              },
              {
                title: 'Clean Soil',
                desc: 'Ready for immediate plotting',
                icon: Check,
              },
            ].map((feature, index) => (
              <Card
...
export default SonepurGreenEstatePage
